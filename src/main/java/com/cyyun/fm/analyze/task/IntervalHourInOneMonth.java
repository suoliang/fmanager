 ...
 * @version 1.0.0
 */
public class IntervalHourInOneMonth implements SyncStatTimeInterval {
	...
	public static void main(String[] args) {
		IntervalHourInOneMonth intervalTodayPastHour = new IntervalHourInOneMonth();
