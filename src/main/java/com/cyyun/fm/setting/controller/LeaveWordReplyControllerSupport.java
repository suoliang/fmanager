...
@Component
public class LeaveWordReplyControllerSupport {
	@Autowired
	...
	public void addMessageBoardReply(MessageBoardReplyBean query) throws FmMessageBoardReplyException {
		fmMessageBoardReplyService.addMessageBoardReply(query);
	}
	public void updateMessageBoard(MessageBoardBean query) throws FmMessageBoardReplyException {
		fmMessageBoardService.updateMessageBoard(query);
	}
}
